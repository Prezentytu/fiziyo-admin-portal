        ...
        <CardContent className="space-y-6">
          ...
          {status === 'error' && (
            <div className="space-y-3">
              <Button data-testid="common-onboarding-page-btn-257" onClick={handleRetry} className="w-full" size="lg">
                <RefreshCw className="mr-2 h-4 w-4" />
                Spróbuj ponownie
              </Button>

              <Button
                data-testid="common-onboarding-page-btn-262"
                variant="outline"
