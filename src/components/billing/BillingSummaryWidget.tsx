...
export function BillingSummaryWidget({ variant, organizationId, className }: BillingSummaryWidgetProps) {
  ...
  if (isCompact) {
    return (
      ...
      >
        {/* Gradient accent bar */}
        <div className="h-1 bg-linear-to-r from-primary to-primary-dark" />
    ...
    >
      ...
      <CardContent className="pt-0">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {/* Total Amount Card */}
          <div className="rounded-xl border border-primary/40 bg-linear-to-br from-primary/10 to-primary-dark/5 p-5 sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2 mb-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary/20">
