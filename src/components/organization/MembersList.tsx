...
import { MoreVertical, Trash2, Shield, ShieldCheck, User } from 'lucide-react';
...
export function MembersList({ members, organizationId, currentUserId, currentUserRole, onRefresh }: MembersListProps) {
  ...
  const [updateRole] = useMutation(UPDATE_MEMBER_ROLE_MUTATION, {
    refetchQueries: [{ query: GET_ORGANIZATION_MEMBERS_QUERY, variables: { organizationId } }],
  });
