      ...
      <CollapsibleTrigger className="w-full">
        <div
          className={cn(
            ...
            isOpen ? 'border-border bg-surface' : 'border-border/40 bg-surface/50 hover:bg-surface hover:border-border'
          )}
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-muted-foreground">Konfiguracja organizacji i subskrypcja</p>
            </div>
          </div>
          <ChevronDown
