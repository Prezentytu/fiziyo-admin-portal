      ...
      <CardContent className="space-y-6">
        ...
        >
          ...
          <div className="flex-1 space-y-1">
            <Label htmlFor="allowPersonal" className="text-base font-semibold cursor-pointer flex items-center gap-2">
              <Lock className="h-4 w-4 text-muted-foreground" />
              Pozwól na tworzenie osobistych ćwiczeń
            </Label>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Członkowie organizacji mogą tworzyć ćwiczenia widoczne tylko dla siebie. Wyłączenie tej opcji wymusi
              udostępnianie wszystkich ćwiczeń całej organizacji.
            </p>
          </div>
        </div>
        ...
        >
          ...
          />
          <div className="flex-1 space-y-1">
            <Label htmlFor="sharedByDefault" className="text-base font-semibold cursor-pointer flex items-center gap-2">
              <Users className="h-4 w-4 text-muted-foreground" />
              Domyślnie udostępniaj ćwiczenia organizacji
            </Label>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Nowo tworzone ćwiczenia będą automatycznie udostępniane wszystkim członkom organizacji. Użytkownicy nadal
              będą mogli zmienić zakres widoczności ręcznie.
            </p>
          </div>
        </div>
