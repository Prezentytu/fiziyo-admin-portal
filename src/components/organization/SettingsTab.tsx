        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            {canEdit && !isEditingBasic && (
              <Button
                data-testid="settingstab-button-179"
                variant="outline"
                size="sm"
            ...
            {canEdit && (
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <input
                    data-testid="org-settings-tab-input-210"
                    id="logo-upload"
                    type="file"
                    accept="image/*"
                    className="hidden"
                  ...
                  {organization.logoUrl && (
                    <Button
                      data-testid="settingstab-button-219"
                      variant="outline"
                      size="sm"
          ...
          {isEditingBasic ? (
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  data-testid="org-settings-tab-input-243"
                  id="org-name"
                  value={editedName}
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  data-testid="org-settings-tab-textarea-254"
                  id="org-description"
              ...
              <div className="flex items-center gap-2 pt-2">
                <Button
                  data-testid="org-settings-tab-btn-264"
                ...
                <Button
                  data-testid="settingstab-button-272"
                  variant="outline"
