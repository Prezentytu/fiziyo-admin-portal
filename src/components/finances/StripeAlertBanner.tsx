...
export function StripeAlertBanner({ organizationId, className }: Readonly<StripeAlertBannerProps>) {
  ...
  } = useQuery<GetBillingDetailsResponse>(GET_BILLING_DETAILS_QUERY, {
    variables: { organizationId: organizationId || '' },
  ...
  const shouldShowStripeSetup =
    !isManualBillingMode && isBillingDetailsApiEnabled && isBillingConfigured && !isStripeConfigured;
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div className="space-y-1">
              <p
                ...
                data-testid="finance-alert-step-label"
              >
                {bannerStepLabel}
              </p>
