  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <PageHeader title="Tagi i kategorie" description="Zarządzaj tagami dla ćwiczeń" />
        </div>
        <Button
          data-testid="exercise-tags-page-btn-129"
      ...
      <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'tags' | 'categories')}>
        <TabsList>
          <TabsTrigger data-testid="exercise-tags-page-tab-141" value="tags" className="flex items-center gap-2">
            <Tag className="h-4 w-4" />
            Tagi ({filteredTags.length})
          </TabsTrigger>
          <TabsTrigger data-testid="page-tabstrigger-145" value="categories" className="flex items-center gap-2">
