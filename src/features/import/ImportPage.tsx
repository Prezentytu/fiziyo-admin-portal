...
import { FileUp, Sparkles, Dumbbell, Layers, FileText, ArrowLeft, Loader2, CheckCircle, X, Check } from 'lucide-react';
...
export function ImportPage() {
  ...
  const isUploadAnalyzeDisabled = isAnalyzing || (inputMode === 'file' ? !file : pastedText.trim().length < 30);
    ...
    <div className="min-h-full" data-testid="import-page">
        ...
        <div className="flex items-center gap-4 mb-2">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <PageHeader title="Import dokumentów" titleTestId="import-page-title" />
        ...
        <div className="flex items-center">
          {stepConfig.map((s, index) => {
            ...
            return (
              ...
              >
                <button
                  data-testid="import-import-page-btn-168"
                  type="button"
                ...
                >
                  ...
                  <span
                    className={cn('text-sm font-medium transition-colors duration-200 hidden sm:block', stepLabelClass)}
                  >
                    {s.label}
                  </span>
                </button>
      ...
      {step !== 'processing' && step !== 'summary' && step !== 'review-exercises' && (
        <div className="mt-10 flex items-center justify-between border-t border-border/60 pt-6">
          <Button
            data-testid="import-import-page-btn-370"
            variant="outline"
            size="lg"
