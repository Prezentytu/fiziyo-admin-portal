...
import { organizationVerificationAdapter } from '@/features/verification/adapters';
...
export function OrganizationVerificationPage() {
  ...
  return (
    <VerificationQueue
      adapter={organizationVerificationAdapter}
      search={search}
      onSearchChange={(value) => {
        setSearch(value);
        updateUrl(filter, value, 1);
      }}
      loading={queueLoading}
      isEmpty={!queueData?.organizationVerificationQueuePage.items.length}
