...
export function ApproveDialog({ open, onOpenChange, onConfirm, isLoading, exerciseName }: ApproveDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-sm p-6" data-testid="verification-approve-dialog">
        <VisuallyHidden.Root>
          <DialogTitle>Zatwierdź i Opublikuj</DialogTitle>
          <DialogDescription>Potwierdź publikację ćwiczenia do Bazy Globalnej</DialogDescription>
        </VisuallyHidden.Root>
        ...
        <div className="text-center mb-6">
          <h3 className="text-lg font-bold text-foreground mb-1">Zatwierdź i Opublikuj</h3>
          <p className="text-sm text-muted-foreground">
            Publikujesz <strong className="text-foreground">{exerciseName ? `"${exerciseName}"` : 'ćwiczenie'}</strong>{' '}
            do Bazy Globalnej.
          </p>
        </div>
