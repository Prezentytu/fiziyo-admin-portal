...
import type { AdminExercise, VerificationQueueNavigator } from '@/graphql/types/adminExercise.types';
...
export function OrganizationVerificationDetailPage({ params }: Readonly<OrganizationVerificationDetailPageProps>) {
  const { id } = use(params);
