...
export function VerificationPage() {
  ...
  const userName =
    currentUser?.fullname || currentUser?.personalData?.firstName || clerkUser?.firstName || 'Weryfikator';
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <PageHeader
            ...
            description={`Cześć ${userName}, dzięki Tobie baza ćwiczeń jest bezpieczna i profesjonalna.`}
          />
        </div>
      ...
      {exercises.length > 0 && (
        <div className="flex flex-col gap-3 rounded-lg border border-border/60 bg-surface p-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Select
              data-testid="verification-verification-page-select-931"
              value={String(pageMeta.pageSize)}
