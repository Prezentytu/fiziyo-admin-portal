...
- Tester Fizjo / Krytyk Designu / Recepcja Zgłoszeń / Badacz Branży piszą **tylko do Issues** (osobna tożsamość GitHub App/bota, Issues RW bez Contents; nie PAT Adama). Karty: `notatki-adam/grok-bot/karty-botow.md`.
