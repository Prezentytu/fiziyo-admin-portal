...
Jeden podfolder na spec: `assets/SPEC-0xx/` (np. `assets/SPEC-022/parameter-pair.png`). Trafiają tu obrazy, zrzuty ekranów z **kont testowych DEV**, eksporty (JSON, SDL), szkice.
...
- Spec odwołuje się względną ścieżką: `![…](assets/SPEC-022/parameter-pair.png)`.
