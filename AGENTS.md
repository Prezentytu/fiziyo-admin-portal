...
| Zasady inżynierskie                               | `.ai/skills/README.md` (sekcja `principle-*`; z indeksu otwórz pasujące `principle-*/SKILL.md`; lokalne źródło: `.ai/skills/`; upstream reference: `fizjo-app/.agents/skills/principle-*/SKILL.md`) |
