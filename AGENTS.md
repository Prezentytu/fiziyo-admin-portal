...
| Zasady inżynierskie                               | `.ai/skills/README.md` (sekcja `principle-*`; z indeksu otwórz pasujące `principle-*/SKILL.md`; źródło zasad: `fizjo-app/.agents/skills/principle-*/SKILL.md`) |
